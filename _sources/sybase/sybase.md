...
![sybase_agent_1](../image/01-agent/sybase/sybase_agent_1.png)
...
![](../image/01-agent/sybase/sybase_agent_2.png)
...
![](../image/01-agent/sybase/sybase_agent_3.png)

  4. Set the **Backup Server Host**, **Backup Server Port**, and **Access Key**. Click **Next**.

![](../image/01-agent/sybase/sybase_agent_4.png)
...
![](../image/03-database/sybase/sybase_database_1.png)
...
![](../image/03-database/sybase/sybase_login_1.png)
...
![](../image/03-database/sybase/sybase_storaged_1.png)

## First Time Login

1. Before creating the first Sybase backup and restore, go to **Resource** and log in to Sybase.

![](../image/03-database/sybase/sybase_login_2.png)
...
![](../image/03-database/sybase/sybase_login_3.png)
...
![](../image/03-database/sybase/sybase_backup_1.png)
...
![](../image/03-database/sybase/sybase_backup_2.png)
...
![](../image/03-database/sybase/sybase_backup_3.png)
...
![](../image/03-database/sybase/sybase_backup_4.png)
...
![](../image/03-database/sybase/sybase_backup_5.png)
...
![](../image/03-database/sybase/sybase_restore_1.png)
...
![](../image/03-database/sybase/sybase_restore_2.png)
...
![](../image/03-database/sybase/sybase_restore_3.png)
...
![](../image/03-database/sybase/sybase_job_1.png)


- Start: Click ![](../image/03-database/sybase/sybase_job_2.png) to start the job immediately.
- Modify: Click ![](../image/03-database/sybase/sybase_job_3.png) to modify the basic job information, the backup/restore schedule, and the backup/restore options.
- Clone: Click ![](../image/03-database/sybase/sybase_job_4.png) to create multiple similar backup jobs.
- Delete: Click ![](../image/03-database/sybase/sybase_job_5.png) to access the confirmation window. Click **OK** to delete the job.
...
![](../image/03-database/sybase/sybase_time_1.png)
...
![](../image/03-database/sybase/sybase_time_2.png)
