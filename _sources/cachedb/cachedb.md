...
![cache_agent_1](../image/01-agent/cache/cache_agent_1.png)
...
![](../image/01-agent/cache/cache_agent_2.png)
...
![](../image/01-agent/cache/cache_agent_3.png)

 4. Set the **Backup Server Host**, **Backup Server Port**, and **Access Key**. Click **Next**.

![](../image/01-agent/cache/cache_agent_4.png)
...
![](../image/02-license/cache/cache_license_1.png)
...
![](../image/03-database/cache/cache_status_1.png)
...
![](../image/03-database/cache/cache_login_1.png)
...
![](../image/03-database/cache/cache_storage_1.png)
...
![](../image/03-database/cache/cache_login_2.png)

2. Enter the **User** and **Password**. Click **Login**.

![](../image/03-database/cache/cache_login_3.png)
...
![](../image/03-database/cache/cache_backup_1.png)
...
![](../image/03-database/cache/cache_backup_2.png)
...
![](../image/03-database/cache/cache_backup_3.png)
...
![](../image/03-database/cache/cache_backup_4.png)
...
![](../image/03-database/cache/cache_backup_5.png)
...
![](../image/03-database/cache/cache_restore_1.png)
...
![](../image/03-database/cache/cache_restore_2.png)
...
![](../image/03-database/cache/cache_job_1.png)



- Start: Click ![](../image/03-database/cache/cache_job_2.png) to start the job immediately.
- Modify: Click![](../image/03-database/cache/cache_job_3.png) to modify the basic job information, the backup/restore schedule, and the backup/restore options.
- Delete: Click![](../image/03-database/cache/cache_job_4.png) to access the confirmation window. Click **OK** to delete the job.
...
![](../image/03-database/cache/cache_job_5.png)
...
![](../image/03-database/cache/cache_job_6.png)
